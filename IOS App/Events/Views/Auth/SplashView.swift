...
struct SplashView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                // springs out from behind the icon. Fires mid-sequence (0.5s) so it
                // lands alongside the tagline.
                PoweredByVodafone(iconHeight: 16, delay: 0.5)
                    .padding(.bottom, 28)
            }
        }
        .onAppear {
    ...
    private func runAnimations() {
        ...
        // Phase 8 (Powered-by Vodafone) is self-triggered inside PoweredByVodafone
